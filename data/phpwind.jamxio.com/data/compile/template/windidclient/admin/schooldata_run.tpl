...
<div class="wrap">
	<div class="nav">
		<ul class="cc">
			<li class="<?php echo htmlspecialchars(Pw::isCurrent($type == 3), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?type=3&m=windidclient&c=schooldata'; ?>">大学管理</a></li>
			<li class="<?php echo htmlspecialchars(Pw::isCurrent($type == 2), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?type=2&m=windidclient&c=schooldata'; ?>">中学管理</a></li>
			<li class="<?php echo htmlspecialchars(Pw::isCurrent($type == 1), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?type=1&m=windidclient&c=schooldata'; ?>">小学管理</a></li>
		</ul>
	</div>
...
$_var = $type == 3 ? 'province' : 'other';
	...
	<form class="J_ajaxForm" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=windidclient&c=schooldata&a=update'; ?>" method="post">
	<div class="table_full">
...
<?php foreach ($list as $_i) {?>
			<tr>
				...
				<td><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?schoolid=', rawurlencode($_i['schoolid']),'&m=windidclient&c=schooldata&a=delete'; ?>" class="J_school_del">[删除]</a></td>
			</tr>
<?php }?>
		</tbody>
		</table>
...
<script>
var SCHOOL_DEL = "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=windidclient&c=schooldata&a=delete'; ?>"; //schoolid

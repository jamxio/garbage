...
<?php }?>
	...
	<form class="J_ajaxForm J_loading_show" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=windidclient&c=areadata&a=update'; ?>" method="post" style="display:none;">
...
foreach ($list as $_i) {?>
			<tr>
				...
				<td><?php if ($hasLevel < 2) {?>
					<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?parentid=', rawurlencode($_i['areaid']),'&m=windidclient&c=areadata'; ?>" class="mr10 J_region_next" data-name="<?php echo htmlspecialchars($_i['name'], ENT_QUOTES, 'UTF-8');?>" data-type="<?php echo htmlspecialchars($data_role, ENT_QUOTES, 'UTF-8');?>" data-id="<?php echo htmlspecialchars($_i['areaid'], ENT_QUOTES, 'UTF-8');?>">[<?php echo htmlspecialchars($data_name, ENT_QUOTES, 'UTF-8');?>]</a>
					<?php }?>
					<a data-id="<?php echo htmlspecialchars($_i['areaid'], ENT_QUOTES, 'UTF-8');?>" data-role="<?php echo htmlspecialchars($data_role, ENT_QUOTES, 'UTF-8');?>" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?areaid=', rawurlencode($_i['areaid']),'&m=windidclient&c=areadata&a=delete'; ?>" class="J_region_del" data-pdata="{'areaid': '<?php echo htmlspecialchars($_i['areaid'], ENT_QUOTES, 'UTF-8');?>'}">[删除]</a></td>
			</tr>
<?php }?>
		</tbody>
		</table>
...
<div class="core_pop_wrap" id="J_region_pop" style="display:none;">
	<div class="core_pop">
		<form action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=windidclient&c=areadata'; ?>" method="post">
...
Wind.use('dialog', 'draggable', function() {
	...
	//table列表中省市区的html
	var tr_province = '<tr><th data-id="_ID"><div class="J_items">_TEXT</div></th><td><a data-id="_ID" data-type="province" class="mr10 J_region_next" data-name="_PNAME" href="#">[下级城市]</a><a class="J_region_del" data-pdata="{\'areaid\': \'_ID\'}" data-role="province" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?areaid=_ID&m=windidclient&c=areadata&a=delete'; ?>" data-id="_ID">[删除]</a></td></tr>',
		tr_city = '<tr><th data-id="_ID"><div class="J_items">_TEXT</div></th><td><a data-id="_ID" data-type="city" class="mr10 J_region_next" data-name="_CNAME" href="#">[下级区县]</a><a class="J_region_del" data-pdata="{\'areaid\': \'_ID\'}"  data-role="city" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?areaid=_ID&m=windidclient&c=areadata&a=delete'; ?>" data-id="_ID">[删除]</a></td></tr>',
		tr_district = '<tr><th data-id="_ID"><div class="J_items">_TEXT</div></th><td><a class="J_region_del" data-pdata="{\'areaid\': \'_ID\'}"  data-role="district" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?areaid=_ID&m=windidclient&c=areadata&a=delete'; ?>" data-id="_ID">[删除]</a></td></tr>';

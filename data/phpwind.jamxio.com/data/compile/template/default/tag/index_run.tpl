		...
		<div class="tag_page_run cc">
			<div class="tag_nav">
				<ul class="cc">
					...
					<li><a rel="nofollow" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=tag&a=my'; ?>" data-referer="true" class="J_qlogin_trigger">我的话题</a></li>
				</ul>
			</div>
			<!--新话题列表-->
			<div class="mb20">
				<div id="k8fT0PIJ" class="design_layout_style J_mod_layout_none box_no" role="structure_k8fT0PIJ" data-lcm="100">			

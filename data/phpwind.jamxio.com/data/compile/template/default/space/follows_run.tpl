...
?>
		...
		<div class="space_content">
			<div class="box">
				<div class="my_article">
					<div class="hd">
							<h2><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=space&c=follows&uid=', rawurlencode($space->spaceUid); ?>"  class="<?php echo htmlspecialchars($classCurrent[0], ENT_QUOTES, 'UTF-8');?>"><?php echo htmlspecialchars($host, ENT_QUOTES, 'UTF-8');?>的关注</a></h2>
					</div>
				</div>
  ...
  foreach ($follows as $key => $value) { ?>
				<dl class="cc">
					<dt><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=space&uid=', rawurlencode($value['touid']); ?>" data-uid="<?php echo htmlspecialchars($value['touid'], ENT_QUOTES, 'UTF-8');?>" class="J_user_card_show"><img class="J_avatar" src="<?php echo htmlspecialchars(Pw::getAvatar($value['touid'], 'small'), ENT_QUOTES, 'UTF-8');?>" data-type="small" width="50" height="50" /></a><a rel="nofollow" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=message&c=message&a=pop&username=', rawurlencode($value['username']); ?>" data-name="<?php echo htmlspecialchars($value['username'], ENT_QUOTES, 'UTF-8');?>" class="called J_send_msg_pop J_qlogin_trigger">打招呼</a></dt>
					<dd>
						<div class="title">
  ...
  if (isset($fans[$value['uid']])) {?>
							...
							?>
							<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=my&c=follow&a=add'; ?>" class="core_follow J_spaceta_follow J_qlogin_trigger" data-followed="<?php echo htmlspecialchars($isfan, ENT_QUOTES, 'UTF-8');?>" data-uid="<?php echo htmlspecialchars($value['touid'], ENT_QUOTES, 'UTF-8');?>">加关注</a>
							<?php  } ?>
						</div>
					</dd>
				</dl>
...
?>
	<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=space&c=follows&page=', rawurlencode($_page_i); 
...
<script>
var URL_UNFOLLOW = "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=my&c=follow&a=delete'; ?>",
		URL_FOLLOW = "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=my&c=follow&a=add'; ?>";
//引入js组件

...
?>
<link href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'themes').'/site/default/css'.Wekit::getGlobal('theme','debug'); ?>/app.css?v=<?php echo htmlspecialchars(NEXT_RELEASE, ENT_QUOTES, 'UTF-8');?>" rel="stylesheet" />
</head>
<body>
<div class="wrap">
...
<div class="tac"> </div>
	<div class="main_wrap">
		<div class="bread_crumb">
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/',''; ?>" class="home" title="<?php echo Wekit::C("site", "info.name"); ?>">首页</a><em>&gt;</em><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=appcenter'; ?>">应用中心</a>
		</div>
		<div class="main cc">
			<div class="main_body">
...
$app['logo'] = Wekit::url()->extres . '/' . $app['alias'] . '/' . $app['logo'];
							 ...
							 ?>
 								<li>
									<a href="<?php echo htmlspecialchars($app['url'], ENT_QUOTES, 'UTF-8');?>" class="app_icon"><b></b><img src="<?php echo htmlspecialchars($app['logo'], ENT_QUOTES, 'UTF-8');?>" onerror="this.onerror=null;this.src='<?php echo htmlspecialchars(Wind::getComponent('response')->getData('G','url','images'), ENT_QUOTES, 'UTF-8');?>/admin/yy.png'" width="80" height="80" alt="<?php echo htmlspecialchars($app['name'], ENT_QUOTES, 'UTF-8');?>" /></a>
									<div>
										<h3 class="title"><a href="<?php echo htmlspecialchars($app['url'], ENT_QUOTES, 'UTF-8');?>"><?php echo htmlspecialchars($app['name'], ENT_QUOTES, 'UTF-8');?></a></h3>
										<p class="s6"><?php echo htmlspecialchars($app['desc'], ENT_QUOTES, 'UTF-8');?></p>
										<a href="<?php echo htmlspecialchars($app['url'], ENT_QUOTES, 'UTF-8');?>" class="in gray">进入<em>&gt;&gt;</em></a>
									</div>
								</li>
								<?php  } ?>
							</ul>
...
?>
	<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=appcenter&orderby=', rawurlencode($orderby),'&page=', rawurlencode($_page_i); 

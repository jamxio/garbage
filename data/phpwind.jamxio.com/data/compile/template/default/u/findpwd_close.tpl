			...
			<div class="reg_cont_wrap">
				<div class="reg_cont">
					<div class="reg_message reg_ignore">
						<h2><?php echo htmlspecialchars(Wekit::C('site','info.name'), ENT_QUOTES, 'UTF-8');?> 网站暂不支持自助找回密码。如有需要，请联系管理员！</h2>
						<p><?php echo htmlspecialchars($close, ENT_QUOTES, 'UTF-8');?></p>
						<p><a href="javascript:window.history.go(-1);" class="s4 mr10">返回上一页面</a><span class="mr10">或者</span><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/',''; ?>" class="s4">返回首页</a></p>
					</div>
				</div>
			</div>
			<div class="reg_side">

...
<div id="content">
<h2><?php echo L('use_email_get_password');?></h2>
	<form method="post" action="" id="myform">
		<div class="col-left form-login form-reg">
			...
			<div class="reg">
				<div class="submit"><input type="submit" name="dosubmit" value="<?php echo L('submit');?>" style="width:60px"></div> &nbsp;&nbsp;&nbsp;&nbsp;<a href="?m=member&c=index&a=public_get_password_type">重新选择验证方式</a>
			</div>
		</div>
	</form>

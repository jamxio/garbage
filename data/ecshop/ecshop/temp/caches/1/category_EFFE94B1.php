...
<div class="clear0 "></div>
 <div class="category-body">
  <div id="ur_here"> <div class="path"><div>当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=19">配件</a> <code>&gt;</code> <a href="category.php?id=20">保护壳</a> <code>&gt;</code> 仓品</div></div> </div>
  ...
  <div class="Area">
        ...
        <div class="guige">
            <div class="screeBox"> <strong>品牌：</strong>
                        <a href="category.php?id=20&amp;price_min=0&amp;price_max=0">全部</a>
                                <span>仓品</span>
                      </div>
                        <div class="clear0"></div>
    </div>
        ...
        <td class="tdr"><table border="0" cellspacing="0" cellpadding="0">
            ...
            <td>排序：</td>
              <td><form method="GET" class="sort list-paixu" name="listform">
                    <a href="category.php?category=20&display=grid&brand=15&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list"><img src="themes/default/images/goods_id_ASC.gif" alt="按上架时间排序"></a> <a href="category.php?category=20&display=grid&brand=15&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/default/images/shop_price_default.gif" alt="按价格排序"></a> <a href="category.php?category=20&display=grid&brand=15&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/default/images/last_update_default.gif" alt="按更新时间排序"></a>

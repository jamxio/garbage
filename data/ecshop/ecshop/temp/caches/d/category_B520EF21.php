        ...
        <td class="tdr"><table border="0" cellspacing="0" cellpadding="0">
            ...
            <td>排序：</td>
              <td><form method="GET" class="sort list-paixu" name="listform">
                    <a href="category.php?category=3&display=grid&brand=4&price_min=0&price_max=0&filter_attr=239.0.0.232&page=1&sort=goods_id&order=DESC#goods_list"><img src="themes/default/images/goods_id_default.gif" alt="按上架时间排序"></a> <a href="category.php?category=3&display=grid&brand=4&price_min=0&price_max=0&filter_attr=239.0.0.232&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/default/images/shop_price_DESC.gif" alt="按价格排序"></a> <a href="category.php?category=3&display=grid&brand=4&price_min=0&price_max=0&filter_attr=239.0.0.232&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/default/images/last_update_default.gif" alt="按更新时间排序"></a>

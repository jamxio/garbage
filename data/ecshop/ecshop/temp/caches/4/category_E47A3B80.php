  ...
  <div class="Area">
        ...
        <div class="guige">
            <div class="screeBox"> <strong>品牌：</strong>
                        <span>全部</span>
                                <a href="category.php?id=3&amp;brand=4&amp;price_min=0&amp;price_max=0&amp;filter_attr=0.229.160.228">飞利浦</a>
                      </div>
            ...
            <div class="screeBox"> <strong>屏幕大小 :</strong>
                        <a href="category.php?id=3&amp;price_min=0&amp;price_max=0&amp;filter_attr=0.0.160.228">全部</a>
                                <span>1.75英寸</span>
                                <a href="category.php?id=3&amp;price_min=0&amp;price_max=0&amp;filter_attr=0.156.160.228">2.6英寸</a>
                      </div>
            ...
            <div class="screeBox"> <strong>外观样式 :</strong>
                        <a href="category.php?id=3&amp;price_min=0&amp;price_max=0&amp;filter_attr=0.229.160.0">全部</a>
                                <span>滑盖</span>
                                <a href="category.php?id=3&amp;price_min=0&amp;price_max=0&amp;filter_attr=0.229.160.232">直板</a>
                      </div>
            <div class="clear0"></div>
    </div>
        ...
        <td class="tdr"><table border="0" cellspacing="0" cellpadding="0">
            ...
            <td>排序：</td>
              <td><form method="GET" class="sort list-paixu" name="listform">
                    <a href="category.php?category=3&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0.229.160.228&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/default/images/goods_id_DESC.gif" alt="按上架时间排序"></a> <a href="category.php?category=3&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0.229.160.228&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/default/images/shop_price_default.gif" alt="按价格排序"></a> <a href="category.php?category=3&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0.229.160.228&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/default/images/last_update_default.gif" alt="按更新时间排序"></a>

...
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;"><img src="images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    ...
    <?php else: ?>
    <span class="<?php if ($this->_var['authorization']): ?>authorize<?php else: ?>noauthorize<?php endif; ?>-icon"><a href="<?php echo $this->_var['single_url']; ?>" target="blank"></a></span>
    <span class="<?php if ($this->_var['authorization']): ?>authorize<?php else: ?>noauthorize<?php endif; ?>"><a href="<?php echo $this->_var['single_url']; ?>" target="_blank"><?php if ($this->_var['authorization']): ?>[<?php echo $this->_var['authorize_name']; ?>]<?php else: ?>[未授权用户]<?php endif; ?></a></span>
    <?php endif; ?>
  </div>

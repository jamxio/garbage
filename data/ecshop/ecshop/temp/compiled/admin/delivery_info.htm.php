...
<form action="order.php" method="post" name="theForm">
  ...
  <tr>
    ...
    <td colspan="3"><?php if ($this->_var['delivery_order']['status'] != 1): ?><input name="invoice_no" type="text" value="<?php echo $this->_var['delivery_order']['invoice_no']; ?>" <?php if ($this->_var['delivery_order']['status'] == 0 || $this->_var['node_info']): ?> readonly="readonly" <?php endif; ?>><?php else: ?><?php echo $this->_var['delivery_order']['invoice_no']; ?><?php endif; ?></td>
  </tr>
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td colspan="6" align="left"><?php if ($this->_var['delivery_order']['status'] == 2): ?><input name="delivery_confirmed" type="submit" value="<?php echo $this->_var['lang']['op_ship']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>/>&nbsp;&nbsp;<?php else: ?><input name="unship" type="submit" value="<?php echo $this->_var['lang']['op_cancel_ship']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> /><?php endif; ?>

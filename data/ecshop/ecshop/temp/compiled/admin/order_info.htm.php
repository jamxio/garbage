...
<table width="100%" cellpadding="3" cellspacing="1">
  <tr>
    <th colspan="8" scope="col"><?php echo $this->_var['lang']['goods_info']; ?><?php if (! $this->_var['node_info']): ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=goods" class="special"><?php echo $this->_var['lang']['edit']; ?></a><?php endif; ?></th>
    </tr>
  <tr>

<?php /* Smarty version 2.6.20, created on 2017-04-29 13:41:22
 ...
 ?>
            ...
            <div id="dashboard">
				...
				<div class="portlet-body form">
				    <form action="index.php" method="post" name="frm" id="frm" onSubmit="return checkad_edit(this);" class="form-horizontal form-bordered form-row-stripped">

    ...
    f._handleItem = function() {
        ...
        if (! (0 === a._pool.length || a._workingSize >= a._limit)) {
            ...
            function(b) {
                ...
                a._onEnd && a._onEnd.call(a._onEndTarget, b);
                else {
...
cc.loader = {
    ...
    loadJs: function(a, b, c) {
        ...
        g = f[0],
        h = f[1],
        f = f[2]; - 1 < navigator.userAgent.indexOf("Trident/5") ? d._loadJs4Dependency(g, h, 0, f) : cc.async.map(h,
        function(a, b, c) {
            a = cc.path.join(g, a);
    ...
    register: function(a, b) {
        if (a && b) {
            ...
            for (var c = 0,
            d = a.length; c < d; c++) this._register["." + a[c].trim().toLowerCase()] = b
        }
    },
    getRes: function(a) {
...
cc._initSys = function(a, b) {
    ...
    var k = e.language,
    k = (k = k ? k: e.browserLanguage) ? k.split("-")[0] : c.LANGUAGE_ENGLISH;
    c.language = k;
    var k = c.BROWSER_TYPE_UNKNOWN,
    m = h.match(/sogou|qzone|liebao|micromessenger|qqbrowser|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|trident|oupeng|opera|miuibrowser|firefox/i) || h.match(/chrome|safari/i);
    ...
    m = c.OS_UNKNOWN; - 1 !== e.appVersion.indexOf("Win") ? m = c.OS_WINDOWS: k ? m = c.OS_IOS: -1 !== e.appVersion.indexOf("Mac") ? m = c.OS_OSX: -1 !== e.appVersion.indexOf("X11") && -1 === e.appVersion.indexOf("Linux") ? m = c.OS_UNIX: h ? m = c.OS_ANDROID: -1 !== e.appVersion.indexOf("Linux") && (m = c.OS_LINUX);
    c.os = m;
    c._supportMultipleAudio = -1 < [c.BROWSER_TYPE_BAIDU, c.BROWSER_TYPE_OPERA, c.BROWSER_TYPE_FIREFOX, c.BROWSER_TYPE_CHROME, c.BROWSER_TYPE_BAIDU_APP, c.BROWSER_TYPE_SAFARI, c.BROWSER_TYPE_UC, c.BROWSER_TYPE_QQ, c.BROWSER_TYPE_MOBILE_QQ, c.BROWSER_TYPE_IE].indexOf(c.browserType); (function(a, c) {
    ...
    try {
        ...
        p = null
    } catch(r) { ("SECURITY_ERR" === r.name || "QuotaExceededError" === r.name) && cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option"),
...
cc.game = {
    ...
    prepare: function(a) {
        ...
        function(d, f) {
            ...
            for (var r = 0,
            s = m.length; r < s; r++) {
                var u = b._getJsListOfModule(n, m[r], e);
                u && (p = p.concat(u))
            }
            p = p.concat(g);
            cc.loader.loadJsWithImg(p,
            function(c) {
                if (c) throw c;
                b._prepared = !0;
                a && a()
...
ClassManager.compileSuper.ClassManager = ClassManager; (function() {
    ...
    cc.Class.extend = function(c) {
        ...
        for (var k = 0,
        m = arguments.length; k < m; ++k) {
            var n = arguments[k],
            p;
            for (p in n) {
                var r = "function" === typeof n[p],
                s = "function" === typeof e[p],
                u = a.test(n[p]);
                b && r && s && u ? (h.value = ClassManager.compileSuper(n[p], p, g), Object.defineProperty(f, p, h)) : r && s && u ? (h.value = function(a, b) {
                    return function() {
                        var c = this._super;
                        this._super = e[a];
                ...
                } (p, n[p]), Object.defineProperty(f, p, h)) : r ? (h.value = n[p], Object.defineProperty(f, p, h)) : f[p] = n[p];
                if (r) {
                    var t, v;
                    if (this.__getters__ && this.__getters__[p]) {
                        var r = this.__getters__[p],
                        w;
                        for (w in this.__setters__) if (this.__setters__[w] === r) {
                            v = w;
                            break
                        }
                        cc.defineGetterSetter(f, r, n[p], n[v] ? n[v] : f[v], p, v)
                    }
                    if (this.__setters__ && this.__setters__[p]) {
                        ...
                        cc.defineGetterSetter(f, r, n[t] ? n[t] : f[t], n[p], t, p)
                    }
                }
            }
        }
...
case cc.sys.BROWSER_TYPE_SAFARI:
    ...
    break;
case cc.sys.BROWSER_TYPE_CHROME:
    cc.__BrowserGetter.__defineGetter__("target-densitydpi",
    function() {
...
cc.inputManager = {
    ...
    registerSystemEvent: function(a) {
        if (!this._isRegisterEvent) {
            ...
            e = !1;
            cc.sys.isMobile && (e = !0);
            c && (cc._addEventListener(window, "mousedown",
            function() {
                b._mousePressed = !0
            },
    ...
    if (! (1 >= e)) {
        ...
        h = d; h < e; h++) {
            ...
            if (0 === h) m = cc.pPerp(cc.pNormalize(cc.pSub(k, cc.p(a[2 * (h + 1)], a[2 * (h + 1) + 1]))));
                ...
                m = s < cc.degreesToRadians(70) ? cc.pPerp(cc.pNormalize(cc.pMidpoint(p, r))) : s < cc.degreesToRadians(170) ? cc.pNormalize(cc.pMidpoint(p, r)) : cc.pPerp(cc.pNormalize(cc.pSub(n, m)))
            }
            m = cc.pMult(m, b);
            c[2 * f] = k.x + m.x;
            c[2 * f + 1] = k.y + m.y;
...
cc._EventListenerCustom = cc.EventListener.extend({
    ...
    ctor: function(a, b) {
        ...
        var c = this;
        cc.EventListener.prototype.ctor.call(this, cc.EventListener.CUSTOM, a,
        function(a) {
...
cc._EventListenerFocus = cc.EventListener.extend({
    ...
    onFocusChanged: null,
    ctor: function() {
        cc.EventListener.prototype.ctor.call(this, cc.EventListener.FOCUS, cc._EventListenerFocus.LISTENER_ID,
        function(a) {
...
cc.eventManager = {
    ...
    _setDirtyForNode: function(a) {
        ...
        a = a.getChildren();
        for (var b = 0,
        c = a.length; b < c; b++) this._setDirtyForNode(a[b])
    },
    ...
    _updateDirtyFlagForSceneGraph: function() {
        if (0 !== this._dirtyNodes.length) {
            ...
            b, c, d = this._nodeListenersMap,
            e = 0,
            f = a.length; e < f; e++) if (b = d[a[e].__instanceId]) for (var g = 0,
            h = b.length; g < h; g++)(c = b[g]) && this._setDirty(c._getListenerID(), this.DIRTY_SCENE_GRAPH_PRIORITY);
    ...
    _sortEventListenersOfSceneGraphPriorityDes: function(a, b) {
        ...
        return ! a || !b || !d || !e || !c[d.__instanceId] || !c[e.__instanceId] ? -1 : c[b._getSceneGraphPriority().__instanceId] - c[a._getSceneGraphPriority().__instanceId]
    },
    _sortListenersOfFixedPriority: function(a) {
        if (a = this._listenersMap[a]) {
            ...
            if (b && 0 !== b.length) {
                ...
                for (var c = 0,
                d = b.length; c < d && !(0 <= b[c]._getFixedPriority());)++c;
                a.gt0Index = c
            }
        }
    },
    ...
    addListener: function(a, b) {
        ...
        if (a.checkAvailable()) {
            if (cc.isNumber(b)) {
                ...
                a._setRegistered(!0);
                a._setPaused(!1)
            } else a._setSceneGraphPriority(b),
...
cc.rendererWebGL = {
    ...
    transform: function() {
        ...
        a.sort(this._sortNodeByLevelAsc);
        for (var b = 0,
        c = a.length; b < c; b++) a[b].updateStatus();
        a.length = 0
    },
    transformDirty: function() {
        return 0 < this._transformNodePool.length
...
cc.Node.RenderCmd.prototype = {
    ...
    _updateDisplayColor: function(a) {
        ...
        if (this._cascadeColorEnabledDirty && !b._cascadeColorEnabled) {
            ...
            a = b._children;
            b = 0;
            for (d = a.length; b < d; b++) if ((e = a[b]) && e._renderCmd) e._renderCmd._updateDisplayColor(c),
    ...
    _updateDisplayOpacity: function(a) {
        ...
        if (this._cascadeOpacityEnabledDirty && !b._cascadeOpacityEnabled) {
            ...
            c = b._children;
            a = 0;
            for (b = c.length; a < b; a++) if ((d = c[a]) && d._renderCmd) d._renderCmd._updateDisplayOpacity(this._displayedOpacity),
    ...
    updateStatus: function() {
        ...
        d && this._updateDisplayOpacity(); (c || d) && this._updateColor();
    ...
    a.getNodeToParentTransform = function() {
        ...
        if (c || this._dirtyFlag & cc.Node._dirtyFlags.transformDirty) {
            ...
            f = c.c *= r,
            g = c.d *= r;
            if (a._skewX || a._skewY) h = Math.tan( - a._skewX * Math.PI / 180),
            k = Math.tan( - a._skewY * Math.PI / 180),
            Infinity === h && (h = 99999999),
    ...
    a.visit = function(a) {
        ...
        if (c._visible) {
            ...
            if (0 < a) {
                c.sortAllChildren();
                for (c = 0; c < a; c++) if (e = d[c], 0 > e._localZOrder) e._renderCmd.visit(this);
                else break;
    ...
    a._setCachedParent = function(a) {
        if (this._cachedParent !== a) {
            ...
            d = 0,
            e = c.length; d < e; d++) c[d]._renderCmd._setCachedParent(a)
        }
    };
    a.detachFromParent = function() {
        ...
        c, d = 0,
        e = a.length; d < e; d++)(c = a[d]) && c._renderCmd && c._renderCmd.detachFromParent()
    };
    ...
    a.getNodeToParentTransform = function() {
        ...
        if (this._dirtyFlag & cc.Node._dirtyFlags.transformDirty) {
            ...
            u = 1,
            t = 0;
            if (0 !== a._rotationX || 0 !== a._rotationY) r = Math.cos( - n),
            s = Math.sin( - n),
            u = Math.cos( - p),
            t = Math.sin( - p);
            n = a._skewX || a._skewY;
            if (!n && (0 !== e || 0 !== g)) c += u * f * k + -s * h * m,
            d += t * f * k + r * h * m;
            p = this._transform;
            p.a = u * k;
            p.b = t * k;
            ...
            p.tx = c;
            p.ty = d;
            if (n && (p = cc.affineTransformConcat({
                a: 1,
    ...
    a._syncStatus = function(a) {
        ...
        this._dirtyFlag = d;
        e && this._syncDisplayColor();
        c && this._syncDisplayOpacity(); (e || c) && this._updateColor();
        this.transform(a)
    };
    ...
    a.visit = function(a) {
        ...
        if (c._visible) {
            ...
            if ((a = c._children) && 0 < a.length) {
                var e = a.length;
                c.sortAllChildren();
                for (c = 0; c < e; c++) if (a[c] && 0 > a[c]._localZOrder) a[c]._renderCmd.visit(this);
                else break;
...
cc.AtlasNode.create = function(a, b, c, d) {
    ...
    function() {
        ...
        if (d && this._originalTexture && (c = d.getHtmlElementObj())) {
            ...
            if (d = cc.textureCache.getTextureColors(e)) e = cc.rect(0, 0, e.width, e.height),
            c instanceof HTMLCanvasElement ? cc.Sprite.CanvasRenderCmd._generateTintImage(c, d, this._displayedColor, e, c) : (c = cc.Sprite.CanvasRenderCmd._generateTintImage(c, d, this._displayedColor, e), d = new cc.Texture2D, d.initWithElement(c), d.handleLoadedTexture(), a.setTexture(d))
        }
    };
...
cc._tmp.WebGLTexture2D = function() {
    cc.Texture2D = cc.Class.extend({
        ...
        _initPremultipliedATextureWithImage: function(a, b, c) {
            ...
            var n = b * c;
            if (k === d.PIXEL_FORMAT_RGB565) if (g) {
                ...
                e = new Uint16Array(b * c);
                f = a.getData();
                for (m = 0; m < n; ++m) e[m] = (f[m] >> 0 & 255) >> 3 << 11 | (f[m] >> 8 & 255) >> 3 << 6 | (f[m] >> 16 & 255) >> 3 << 1 | (f[m] >> 24 & 255) >> 7 << 0
...
cc._tmp.WebGLTextureCache = function() {
    ...
    a.addImage = function(a, c, d) {
        ...
        f.url = a; (cc.loader._checkIsImageURL(a) ? cc.loader.load: cc.loader.loadImg).call(cc.loader, a,
        function(f, h) {
            if (f) return c && c.call(d, f);
...
cc._renderType === cc._RENDER_TYPE_CANVAS ? (cc.Texture2D = cc.Class.extend({
    ...
    b = a.data;
    for (var e = 0,
    f = b.length; e < f; e += 4) b[e] = b[e + 1] = b[e + 2] = 0.34 * b[e] + 0.5 * b[e + 1] + 0.16 * b[e + 2];
...
_p.addImage = function(a, b, c) {
    ...
    e.url = a; (cc.loader._checkIsImageURL(a) ? cc.loader.load: cc.loader.loadImg).call(cc.loader, a,
    function(e, g) {
        if (e) return b && b.call(c, e);
        cc.textureCache.handleLoadedTexture(a);
        var h = d[a];
...
cc.LayerGradient = cc.LayerColor.extend({
    ...
    setEndColor: function(a) {
        ...
        b.g = a.g;
        b.b = a.b;
        if ((b = this._colorStops) && 0 < b.length) b = b[b.length - 1].color,
        b.r = a.r,
        b.g = a.g,
        b.b = a.b;
        this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.colorDirty)
...
cc.LayerMultiplex.create = function() {
    ...
    a._bakeRendering = function() {
        if (this._cacheDirty) {
            ...
            if (0 < e) {
                a.sortAllChildren();
                for (a = 0; a < e; a++) if (f = d[a], 0 > f._localZOrder) f._renderCmd.visit(this);
                else break;
    ...
    cc.LayerGradient.RenderCmd = {
        updateStatus: function() {
            ...
            b & a.transformDirty && this.transform(null, !0); (c || d || b & a.gradientDirty) && this._updateColor();
            this._dirtyFlag = 0
        }
    }
})(); (function() {
    ...
    a._syncStatus = function(a) {
        ...
        e && this._syncDisplayColor();
        f && this._syncDisplayOpacity();
        d & c.transformDirty && this.transform(a); (e || f || d & c.gradientDirty) && this._updateColor()
    };
    a._updateColor = function() {
        var a = this._node,
        c = a._contentSize,
        ...
        if (a._colorStops) {
            ...
            this._colorStopsStr = [];
            for (d = 0; d < a._colorStops.length; d++) c = a._colorStops[d].color,
    ...
    a._updateColor = function() {
        for (var a = this._displayedColor,
        c = this._displayedOpacity,
        d = this._squareColors,
        e = 0; 4 > e; e++) d[e].r = a.r,
        d[e].g = a.g,
        d[e].b = a.b,
        d[e].a = c;
    ...
    a._syncStatus = function(a) {
        ...
        e && this._syncDisplayColor();
        f && this._syncDisplayOpacity();
        this.transform(a); (e || f || d & c.gradientDirty) && this._updateColor()
    };
    a._updateColor = function() {
        this._dirtyFlag ^= this._dirtyFlag & cc.Node._dirtyFlags.gradientDirty;
        var a = this._node,
        ...
        if (c && !(2 > c.length)) {
            ...
            for (f = 0; f < e; f++) h.push(new cc.Vertex2F(0, 0, m, p * f)),
            k.push(cc.color(0, 0, 0, 255, n, r * f));
            ...
            for (f = 0; f < d; f++) m = c[f].p * g.height,
            n = cc.pointApplyAffineTransform( - a.x, m - a.y, e),
            h[2 * f].x = n.x,
            h[2 * f].y = n.y,
            m = cc.pointApplyAffineTransform(g.width - a.x, m - a.y, e),
            h[2 * f + 1].x = m.x,
            h[2 * f + 1].y = m.y;
            g = this._displayedOpacity / 255;
            for (f = 0; f < d; f++) h = c[f].color,
            a = k[2 * f],
            e = k[2 * f + 1],
            a.r = h.r,
            a.g = h.g,
...
cc.Sprite = cc.Node.extend({
    ...
    removeAllChildren: function(a) {
        var b = this._children,
        c = this._batchNode;
        if (c && null != b) for (var d = 0,
        e = b.length; d < e; d++) c.removeSpriteFromAtlas(b[d]);
    ...
    initWithTexture: function(a, b, c, d) {
        ...
        if (!e) return this._rectRotated = c,
        ...
        a.addEventListener("load", this._renderCmd._textureLoadedCallback, this),
        this.texture = a,
        !0;
        b || (b = cc.rect(0, 0, a.width, a.height));
    ...
    setSpriteFrame: function(a) {
        ...
        c = a.getTexture();
        a.textureLoaded() ? (c !== b._texture && (b.texture = c), b.setTextureRect(a.getRect(), a.isRotated(), a.getOriginalSize())) : (b._textureLoaded = !1, a.addEventListener("load",
        function(a) {
            b._textureLoaded = !0;
            var c = a.getTexture();
    ...
    setBatchNode: function(a) { (this._batchNode = a) ? (this._transformToBatch = cc.affineTransformIdentity(), this.textureAtlas = this._batchNode.getTextureAtlas()) : (this.atlasIndex = cc.Sprite.INDEX_NOT_INITIALIZED, this.textureAtlas = null, this.dirty = this._recursiveDirty = !1, this._renderCmd._resetForBatchNode())
    },
    setTexture: function(a) {
        if (!a) return this._renderCmd._setTexture(null);
        cc.isString(a) ? (a = cc.textureCache.addImage(a), a._textureLoaded ? (this._clearRect(), this._renderCmd._setTexture(a), this._changeRectWithTexture(a.getContentSize()), this.setColor(this._realColor), this._textureLoaded = !0) : a.addEventListener("load",
        function() {
            this._clearRect();
    ...
    _changeRectWithTexture: function(a) {
        if (a && (a.width || a.height)) {
            var b = this.getTextureRect(); ! b.height && !b.width && (a.x = a.x || 0, a.y = a.y || 0, a.width = a.width || 0, a.height = a.height || 0, this.setTextureRect(a))
        }
    },
    _createRenderCmd: function() {
...
delete cc._tmp.PrototypeSprite; (function() {
    ...
    function() {
        var a = this._node,
        c = this._displayedColor;
        if (255 === c.r && 255 === c.g && 255 === c.b) this._colorized && (this._colorized = !1, a.texture = this._originalTexture);
        else {
            var d, e = a._texture,
            f = this._textureCoord;
            if (e && (f.validRect && this._originalTexture) && (d = e.getHtmlElementObj())) this._colorized = !0,
        ...
        if (255 === c.r && 255 === c.g && 255 === c.b) this._colorized && (this._colorized = !1, a.texture = this._originalTexture);
            ...
            var d, e = a._texture,
            f = this._textureCoord;
            if (e && (f.validRect && this._originalTexture) && (d = e.getHtmlElementObj())) if (e = cc.textureCache.getTextureColors(this._originalTexture.getHtmlElementObj())) this._colorized = !0,
            d instanceof HTMLCanvasElement && !this._rectRotated && !this._newTextureWhenChangeColor ? cc.Sprite.CanvasRenderCmd._generateTintImage(d, e, c, f, d) : (d = cc.Sprite.CanvasRenderCmd._generateTintImage(d, e, c, f), e = new cc.Texture2D, e.initWithElement(d), e.handleLoadedTexture(), a.texture = e)
        }
    };
    a.getQuad = function() {
        return null
    ...
    a.updateTransform = function() {
        var a = this._node;
        if (a.dirty) {
            var c = a._parent; ! a._visible || c && c !== a._batchNode && c._shouldBeHidden ? a._shouldBeHidden = !0 : (a._shouldBeHidden = !1, a._transformToBatch = !c || c === a._batchNode ? this.getNodeToParentTransform() : cc.affineTransformConcat(this.getNodeToParentTransform(), c._transformToBatch));
            a._recursiveDirty = !1;
            a.dirty = !1
        }
    ...
    a._textureLoadedCallback = function(a) {
        if (!this._textureLoaded) {
            ...
            a = d._displayedColor; (255 !== a.r || 255 !== a.g || 255 !== a.b) && d._updateColor();
    ...
    cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor = function(a) {
        function c() {
            ...
            for (var k = k.getImageData(0, 0, e, h).data, m = 0; 4 > m; m++) {
                ...
                for (var p = c.tempCtx.getImageData(0, 0, e, h), r = p.data, s = 0; s < k.length; s += 4) r[s] = 0 === m ? k[s] : 0,
                r[s + 1] = 1 === m ? k[s + 1] : 0,
                r[s + 2] = 2 === m ? k[s + 2] : 0,
                r[s + 3] = k[s + 3];
    ...
    a._updateBlendFunc = function() {
        if (this._batchNode) cc.log(cc._LogInfos.Sprite__updateBlendFunc);
            ...
            var a = this._node; ! a._texture || !a._texture.hasPremultipliedAlpha() ? (a._blendFunc.src = cc.SRC_ALPHA, a._blendFunc.dst = cc.ONE_MINUS_SRC_ALPHA, a.opacityModifyRGB = !1) : (a._blendFunc.src = cc.BLEND_SRC, a._blendFunc.dst = cc.BLEND_DST, a.opacityModifyRGB = !0)
        }
    };
    a._setTexture = function(a) {
        var c = this._node;
...
cc.SpriteBatchNode = cc.Node.extend({
    ...
    insertChild: function(a, b) {
        ...
        if (d) {
            c = 0;
            for (f = d.length || 0; c < f; c++) if (e = d[c]) {
    ...
    appendChild: function(a) {
        ...
        a = a.children;
        for (var b = 0,
        c = a.length || 0; b < c; b++) this.appendChild(a[b])
    },
    ...
    removeAllChildren: function(a) {
        var b = this._descendants;
        if (b && 0 < b.length) for (var c = 0,
        d = b.length; c < d; c++) b[c] && (b[c].batchNode = null);
        cc.Node.prototype.removeAllChildren.call(this, a);
        this._descendants.length = 0;
...
cc.SpriteBatchNode.createWithTexture = cc.SpriteBatchNode.create; (function() {
    ...
    a.setTexture = function(a) {
        this._texture = a;
        for (var c = this._node._children,
        d = 0; d < c.length; d++) c[d].setTexture(a)
    };
    a.updateChildrenAtlasIndex = function(a) {
        for (var c = this._node._descendants.length = 0,
        d = a.length; c < d; c++) this._updateAtlasIndex(a[c])
    };
    a._updateAtlasIndex = function(a) {
        var c = this._node._descendants,
        d = a.children,
        e, f = d.length;
        for (e = 0; e < f; e++) if (0 > d[e]._localZOrder) c.push(d[e]);
        else break;
    ...
    a.updateChildrenAtlasIndex = function(a) {
        for (var c = 0,
        d = 0; d < a.length; d++) c = this._updateAtlasIndex(a[d], c)
    };
    a._updateBlendFunc = function() {
        ...
        for (var f in b) {
            ...
            if (g) {
                ...
                if (0 == e) {
                    ...
                    g = g.originalHeight; (!h || !g) && cc.log(cc._LogInfos.spriteFrameCache__getFrameConfig);
                    h = Math.abs(h);
                    g = Math.abs(g);
                    c.size = cc.size(h, g)
...
cc.Director = cc.Class.extend({
    ...
    setNextScene: function() {
        ...
        cc.renderer.childrenOrderDirty = !0;
        this._nextScene = null; ! a && null !== this._runningScene && (this._runningScene.onEnter(), this._runningScene.onEnterTransitionDidFinish())
    },
...
cc.Scheduler = cc.Class.extend({
    ...
    _removeUpdateFromHash: function(a) {
        if (a = this._hashForUpdates[a.target.__instanceId]) cc.arrayRemoveObject(a.list, a.entry),
        delete this._hashForUpdates[a.target.__instanceId],
        a.entry = null,
        a.target = null
    },
    ...
    schedule: function(a, b, c, d, e, f, g) {
        ...
        h = !0; ! 1 === h ? 5 === arguments.length && (g = e, f = d, e = 0, d = cc.REPEAT_FOREVER) : 4 === arguments.length && (f = d, d = cc.REPEAT_FOREVER, e = 0);
        cc.assert(b, cc._LogInfos.Scheduler_scheduleCallbackForTarget_3); ! 1 === h && cc.assert(g, "key should not be empty!");
    ...
    isScheduled: function(a, b) {
        ...
        d = 0; d < c.length; ++d) if (a === c[d].getKey()) return ! 0;
        return ! 1
    },
    ...
    pauseAllTargetsWithMinPriority: function(a) {
        ...
        b.push(c.target);
        if (0 > a) for (e = 0; e < this._updatesNegList.length; e++) if ((c = this._updatesNegList[e]) && c.priority >= a) c.paused = !0,
        b.push(c.target);
        if (0 >= a) for (e = 0; e < this._updates0List.length; e++) if (c = this._updates0List[e]) c.paused = !0,
        b.push(c.target);
        for (e = 0; e < this._updatesPosList.length; e++) if ((c = this._updatesPosList[e]) && c.priority >= a) c.paused = !0,
        b.push(c.target);
        return b
    },
...
cc.DrawingPrimitiveCanvas = cc.Class.extend({
    ...
    drawPoly: function(a, b, c, d) {
        ...
        if (null != a) {
            ...
            for (var e = 1,
            h = a.length; e < h; e++) b.lineTo(a[e].x * f, -a[e].y * g);
            c && b.closePath();
            d ? b.fill() : b.stroke()
        }
    },
...
cc.LabelTTF._firsrEnglish = /^[a-zA-Z0-9\u00c4\u00d6\u00dc\u00e4\u00f6\u00fc\u00df\u00e9\u00e8\u00e7\u00e0\u00f9\u00ea\u00e2\u00ee\u00f4\u00fb]/; (function() {
    ...
    a._updateTexture = function() {
        ...
        d = this._labelCanvas,
        e = a._contentSize;
        if (0 === a._string.length) return d.width = 1,
        d.height = e.height || 1,
        a._texture && a._texture.handleLoadedTexture(),
        a.setTextureRect(cc.rect(0, 0, 1, e.height)),
        !0;
    ...
    a._drawTTFInCanvas = function(a) {
        if (a) {
            ...
            if (this._isMultiLine) {
                ...
                g === cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM ? m = d - 2 * k + f - d * c: g === cc.VERTICAL_TEXT_ALIGNMENT_CENTER && (m = (d - 2 * k) / 2 + (f - d * c) / 2);
                for (g = 0; g < c; g++) h = this._strings[g],
                p = -f + (d * g + k) + m,
                n && a.strokeText(h, e, p),
                a.fillText(h, e, p)
            } else g !== cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM && (m = g === cc.VERTICAL_TEXT_ALIGNMENT_TOP ? m - f: m - 0.5 * f),
            n && a.strokeText(c._string, e, m),
            a.fillText(c._string, e, m)
        }
    };
    a._checkWarp = function(a, c, d) {
        ...
        f = this._measure(e);
        if (f > d && 1 < e.length) {
            for (var g = e.length * (d / f) | 0, h = e.substr(g), k = f - this._measure(h), m, n = 0, p = 0; k > d && 100 > p++;) g *= d / k,
            g |= 0,
            h = e.substr(g),
            k = f - this._measure(h);
            for (p = 0; k < d && 100 > p++;) h && (n = (m = cc.LabelTTF._wordRex.exec(h)) ? m[0].length: 1, m = h),
            g += n,
            h = e.substr(g),
            k = f - this._measure(h);
            g -= n;
            ...
            d = e.substr(0, g);
            if (cc.LabelTTF.wrapInspection && cc.LabelTTF._symbolRex.test(m || h)) f = cc.LabelTTF._lastWordRex.exec(d),
            g -= f ? f[0].length: 0,
            m = e.substr(g),
            d = e.substr(0, g);
            if (cc.LabelTTF._firsrEnglish.test(m) && (f = cc.LabelTTF._lastEnglish.exec(d)) && d !== f[0]) g -= f[0].length,
            m = e.substr(g),
            d = e.substr(0, g);
            a[c] = m || h;
            a.splice(c, 0, d)
...
cc.ActionManager = cc.Class.extend({
    ...
    update: function(a) {
        ...
        c, d = 0; d < b.length; d++) {
            ...
            if (!c.paused) for (c.actionIndex = 0; c.actionIndex < (c.actions ? c.actions.length: 0); c.actionIndex++) if (c.currentAction = c.actions[c.actionIndex], c.currentAction) {
...
cc.math.almostEqual = function(a, b) {
    ...
    a.math.Ray2.prototype.intersectLineSegment = function(b, d, e) {
        ...
        r = d.y,
        s = (r - n) * (h - f) - (p - m) * (k - g);
        if (s > -a.math.EPSILON && s < a.math.EPSILON) return ! 1;
        n = ((p - m) * (g - n) - (r - n) * (f - m)) / s;
        m = f + n * (h - f);
        n = g + n * (k - g);
...
var Float32Array = Float32Array || Array; (function(a) {
    ...
    a.math.Matrix4._gaussj = function(a, b) {
        ...
        t = [0, 0, 0, 0];
        for (c = 0; 4 > c; c++) {
            for (m = r = 0; 4 > m; m++) if (1 !== t[m]) for (n = 0; 4 > n; n++) 0 === t[n] && (p = Math.abs(a.get(m, n)), p >= r && (r = p, k = m, d = n)); ++t[d];
            if (k !== d) {
        ...
        for (m = 3; 0 <= m; m--) if (u[m] !== s[m]) for (n = 0; 4 > n; n++) a.swap(n, u[m], n, s[m]);
        return ! 0
    };
    ...
    a.kmMat4Multiply = function(a, b, c) {
        ...
        d[8] = K * c + L * r + M * v + N * x;
        d[9] = K * b + L * s + M * w + N * A;
        d[10] = K * n + L * u + M * y + N * B;
        d[11] = K * p + L * t + M * z + N * k;
        d[12] = O * c + P * r + Q * v + m * x;
        d[13] = O * b + P * s + Q * w + m * A;
        d[14] = O * n + P * u + Q * y + m * B;
        d[15] = O * p + P * t + Q * z + m * k;
        return a
    };
    b.multiply = function(a) {
        var b = this.mat,
        ...
        b[8] = J * a + K * n + L * u + M * y;
        b[9] = J * d + K * p + L * t + M * z;
        b[10] = J * k + K * r + L * v + M * x;
        b[11] = J * m + K * s + L * w + M * A;
        b[12] = N * a + O * n + P * u + c * y;
        b[13] = N * d + O * p + P * t + c * z;
        b[14] = N * k + O * r + P * v + c * x;
        b[15] = N * m + O * s + P * w + c * A;
        return this
    };
...
cc.GLProgram = cc.Class.extend({
    ...
    _updateUniformLocation: function(a, b, c) {
        ...
        c = !0;
        for (var d = null,
        e = 0; e < this._hashForUniforms.length; e++) this._hashForUniforms[e].location == a && (d = this._hashForUniforms[e]);
...
cc.Animate = cc.ActionInterval.extend({
    ...
    update: function(a) {
        ...
        for (var b = this._animation.getFrames(), c = b.length, d = this._splitTimes, e = this._nextFrame; e < c; e++) if (d[e] <= a) this.target.setSpriteFrame(b[e].getSpriteFrame()),
        this._nextFrame = e + 1;
        else break
    },
    reverse: function() {
...
cc.CardinalSplineTo = cc.ActionInterval.extend({
    ...
    update: function(a) {
        ...
        if (cc.ENABLE_STACKABLE_ACTIONS && (c = this.target.getPositionX() - this._previousPosition.x, a = this.target.getPositionY() - this._previousPosition.y, 0 !== c || 0 !== a)) d = this._accumulatedDiff,
        c = d.x + c,
        a = d.y + a,
        d.x = c,
        d.y = a,
...
cc.LabelAtlas = cc.AtlasNode.extend({
    ...
    initWithString: function(a, b, c, d, e) {
        ...
        b || (this._string = f, k.addEventListener("load",
        function(a) {
...
cc.LabelAtlas.create = function(a, b, c, d, e) {
    ...
    a.updateAtlasValues = function() {
        ...
        g = a._itemHeight,
        h = 0; h < d; h++) {
            var k = c.charCodeAt(h) - a._mapStartChar.charCodeAt(0),
            m = parseInt(k % a._itemsPerRow, 10),
            k = parseInt(k / a._itemsPerRow, 10),
            m = cc.rect(m * f, k * g, f, g),
            k = c.charCodeAt(h),
            n = a.getChildByTag(h);
    ...
    a.updateAtlasValues = function() {
        ...
        p = a._itemWidth, r = 0; r < d; r++) {
            var s = c.charCodeAt(r) - a._mapStartChar.charCodeAt(0),
            u = s % a._itemsPerRow,
            t = 0 | s / a._itemsPerRow,
            v;
            cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL ? (u = (2 * u * h + 1) / (2 * g), s = u + (2 * h - 2) / (2 * g), t = (2 * t * k + 1) / (2 * f), v = t + (2 * k - 2) / (2 * f)) : (u = u * h / g, s = u + h / g, t = t * k / f, v = t + k / f);
            var w = m[r],
            y = w.tl,
            z = w.tr,
            x = w.bl,
...
cc.LabelBMFont = cc.SpriteBatchNode.extend({
    ...
    initWithString: function(a, b, c, d, e) {
        ...
        if (b) {
            ...
            this._config = f;
            this._fntFile = b;
            b = cc.textureCache.addImage(f.atlasName); (this._textureLoaded = f = b.isLoaded()) || b.addEventListener("load",
            function(a) {
                this._textureLoaded = !0;
    ...
    createFontChars: function() {
        ...
        if (0 !== g) {
            ...
            e = -(n - n * e),
            s = -1;
            for (h = 0; h < g; h++) if (n = f.charCodeAt(h), 0 !== n) if (10 === n) b = 0,
            e -= k.commonHeight;
            else {
                var u = m[s << 16 | n & 65535] || 0,
                t = p[n];
                if (t) {
                    var v = cc.rect(t.rect.x, t.rect.y, t.rect.width, t.rect.height),
                    v = cc.rectPixelsToPoints(v);
                    v.x += this._imageOffset.x;
                    v.y += this._imageOffset.y; (s = this.getChildByTag(h)) ? this._renderCmd._updateCharTexture(s, v, n) : (s = new cc.Sprite, s.initWithTexture(a, v, !1), s._newTextureWhenChangeColor = !0, this.addChild(s, 0, h));
                    s.opacityModifyRGB = this._opacityModifyRGB;
                    this._renderCmd._updateCharColorAndOpacity(s);
                    v = cc.p(b + t.xOffset + 0.5 * t.rect.width + u, e + (k.commonHeight - t.yOffset) - 0.5 * v.height * cc.contentScaleFactor());
                    s.setPosition(cc.pointPixelsToPoints(v));
                    b += t.xAdvance + u;
                    s = n;
                    d < b && (d = b)
    ...
    _checkWarp: function(a, b, c, d) {
        ...
        if (h > c && 1 < e.length) {
            d = e.length * (c / h) | 0;
            for (var g = e.substr(d), k = h - this._getCharsWidth(f + d, g.length - 1), m, n = 0, p = 0; k > c && 100 > p++;) d *= c / k,
            d |= 0,
            g = e.substr(d),
            k = h - this._getCharsWidth(f + d, g.length - 1);
            for (p = 0; k < c && 100 > p++;) g && (n = (m = cc.LabelTTF._wordRex.exec(g)) ? m[0].length: 1, m = g),
            this._lineBreakWithoutSpaces && (n = 0),
            d += n,
            g = e.substr(d),
            k = h - this._getCharsWidth(f + d, g.length - 1);
            d -= n;
            ...
            c = e.substr(0, d);
            if (cc.LabelTTF.wrapInspection && cc.LabelTTF._symbolRex.test(m || g)) n = (f = cc.LabelTTF._lastWordRex.exec(c)) ? f[0].length: 0,
            this._lineBreakWithoutSpaces && (n = 0),
            d -= n,
            m = e.substr(d),
            c = e.substr(0, d);
            if (cc.LabelTTF._firsrEnglish.test(m) && (f = cc.LabelTTF._lastEnglish.exec(c)) && c !== f[0]) n = f[0].length,
            this._lineBreakWithoutSpaces && (n = 0),
            d -= n,
            m = e.substr(d),
            c = e.substr(0, d);
    ...
    updateLabel: function() {
        ...
        if (this._alignment !== cc.TEXT_ALIGNMENT_LEFT) {
            ...
            f = [];
            for (g = 0; g < e; g++) if (10 === this._string[g].charCodeAt(0) || 0 === this._string[g].charCodeAt(0)) {
                b = 0;
                var h = f.length;
                if (0 === h) d++;
    ...
    setFntFile: function(a) {
        if (null != a && a !== this._fntFile) {
            var b = cc.loader.getRes(a);
            b ? (this._fntFile = a, this._config = b, a = cc.textureCache.addImage(b.atlasName), this._textureLoaded = b = a.isLoaded(), this.texture = a, this._renderCmd._updateFntFileTexture(), b ? this.createFontChars() : a.addEventListener("load",
            function(a) {
                this._textureLoaded = !0;
                this.texture = a;
...
cc.loader.register(["fnt"], cc._fntLoader); (function() {
...
cc.MenuItemSprite = cc.MenuItem.extend({
    ...
    initWithNormalSprite: function(a, b, c, d, e) {
        ...
        this.height = a.height,
        a.textureLoaded && !a.textureLoaded() && a.addEventListener("load",
        function(a) {
            this.width = a.width;
            this.height = a.height;
...
cc.MenuItemToggle = cc.MenuItem.extend({
    ...
    initWithItems: function(a) {
        ...
        for (var c = this.subItems,
        d = c.length = 0; d < b; d++) a[d] && c.push(a[d]);
...
cc.Menu = cc.Layer.extend({
    ...
    alignItemsInColumns: function() {
        ...
        if (m && 0 < m.length) {
            b = 0;
            for (k = m.length; b < k; b++) if (! (d >= a.length) && (g = a[d])) h = m[b].height,
            e = e >= h || isNaN(h) ? e: h,
            ++f,
            f >= g && (c += e + 5, e = f = 0, ++d)
        }
    ...
    alignItemsInRows: function() {
        ...
        if (s && 0 < s.length) {
            b = 0;
            for (p = s.length; b < p; b++) if (n = s[b], !(g >= a.length) && (m = a[g])) r = n.width,
            h = h >= r || isNaN(r) ? h: r,
            f += n.height + 5,
            ++k,
            k >= m && (c.push(h), d.push(f), e += h + 10, h = k = 0, f = -5, ++g)
        }
        ...
        if (s && 0 < s.length) {
            b = 0;
            for (p = s.length; b < p; b++) n = s[b],
            0 === m && (m = a[g], u = d[g]),
            r = n._getWidth(),
            h = h >= r || isNaN(r) ? h: r,
            n.setPosition(e + c[g] / 2, u - f.height / 2),
            u -= n.height + 10,
            ++k,
            k >= m && (e += h + 5, h = m = k = 0, ++g)
        }
...
var start = {
    STARTBG: "res/start_bg.jpg",
    STARTBUT: "res/start_but.png"
},
game = {
    NEWBG: "res/new_bg.png",
    CLOSEBUT: "res/close_but.png",
    GAMEBG: "res/game_bg.jpg",
    MOVEBG: "res/move_bg.jpg",
    SPRITEAC1: "res/sp1.png",
    SPRITEAC2: "res/sp2.png",
    SPRITEAC3: "res/sp3.png",
    SPRITEAC4: "res/sp4.png",
    SPRITEJUMP1: "res/t1.png",
    SPRITEJUMP2: "res/t2.png",
    SPRITEJUMP3: "res/t3.png",
    SPRITEJUMP4: "res/t4.png",
    SPRITEJUMP5: "res/t5.png",
    SPRITEJUMP6: "res/t6.png",
    SPRITEJUMP7: "res/t7.png",
    SPRITEJUMP8: "res/t8.png",
    SPRITEJUMP9: "res/t9.png",
    JUMPBUT: "res/jump_but.png",
    OVERBG: "res/over_bg.png",
    REPLAYBUT: "res/replay_but.png",
    MENUBUT: "res/menu_but.png",
    NUMBER: "res/number.png"
},
game_res = [game.GAMEBG, game.NEWBG, game.OVERBG, game.CLOSEBUT, game.SPRITEAC1, game.SPRITEAC2, game.SPRITEAC3, game.SPRITEAC4, game.SPRITEJUMP1, game.SPRITEJUMP2, game.SPRITEJUMP3, game.SPRITEJUMP4, game.JUMPBUT, game.REPLAYBUT, game.MENUBUT, game.NUMBER];
var currentscore = 0,
bestscore = 0;
function saveDollNum(a) {
    a = JSON.stringify(a);
    cc.sys.localStorage.setItem("dollNum", a)
}
function loadDollNum() {
    var a = cc.sys.localStorage.getItem("dollNum");
...
var StartScene = cc.Scene.extend({
    ...
    onEnter: function() {
        ...
        //ggax();
        var a = this;
        cc.loader.loadImg(start.STARTBG, {
            isCrossOrigin: !1
        },
        function(b, c) {
        ...
        cc.loader.loadImg(start.STARTBUT, {
            isCrossOrigin: !1
        },
        function(b, c) {
            var d = new cc.MenuItemImage(c, c, a.startLoadRes, a);
            d.setPosition(240, 140);
            d = new cc.Menu(d);
            d.setPosition(0, 0);
            a.addChild(d, 1)
        })
    },
    startLoadRes: function(a) {
        a.parent.removeFromParent();
        this.loaderLayer || (this.loaderLayer = new ProloadLayer, this.addChild(this.loaderLayer, 2));
        this.loaderLayer.initWithResources(game_res,
        function() {
...
var PROGRESSBAG = "data:image/png;base64,\x3d\x3d",
PROGRESSBG = "data:image/png;base64,",
ProloadLayer = cc.Layer.extend({
    _interval: null,
    _label: null,
    _className: "LoaderScene",
    cb: null,
    ...
    ctor: function() {
        this._super();
        var a = this;
        PROGRESSBG && cc.loader.loadImg(PROGRESSBG, {
            isCrossOrigin: !1
        },
        function(b, c) {
            a.progressBg = new cc.Sprite(c);
            a.progressBg.setPosition(240, 120);
            a.addChild(a.progressBg, 1)
        });
        PROGRESSBAG && cc.loader.loadImg(PROGRESSBAG, {
            isCrossOrigin: !1
        },
        function(b, c) {
            a.progressBar = new cc.Sprite(c);
            a.progressBar.setAnchorPoint(0, 0.5);
            a.progressBar.setPosition(11, 17);
            a.progressBar.setScaleX(0);
            a.progressBg.addChild(a.progressBar);
            a.schedule(a.startLoading, 0.05)
        });
        return ! 0
    },
    onEnter: function() {
    ...
    startLoading: function() {
        var a = this;
        a.unschedule(a.startLoading);
        cc.loader.load(a.resources,
        function(b, c, d) {
            b = Math.min(d / c, 1);
            a.progressBar.setScaleX(b)
        },
        function() {
            a.progressBar.setScaleX(1);
...
var GameLayer = cc.Layer.extend({
    ...
    ctor: function() {
        ...
        this.isHeroJump = !1;
        this.scoreNumber = 0;
        var a = new cc.Sprite(game.GAMEBG);
        a.setAnchorPoint(0, 0);
        this.addChild(a);
        for (a = 0; 2 > a; a++) {
            if (0 == a) {
                var b = new cc.Sprite(game.MOVEBG);
                b.setAnchorPoint(0, 0);
                this.addChild(b);
                b.setColor(cc.color(100, 0, 0));
                b.setScaleX(2);
                b.truewidth = 440
            } else b = new cc.Sprite(game.MOVEBG),
            b.setAnchorPoint(0, 0),
            b.setPosition(520, 0),
            this.addChild(b),
            b.truewidth = 220,
            b.setColor(cc.color(100, 100, 0));
            this.mapArray.push(b)
        }
        a = new cc.MenuItemImage(game.JUMPBUT, game.JUMPBUT, this.jumpCallfunc, this);
        a.setPosition(420, 60);
        a = new cc.Menu(a);
        a.setPosition(cc.p(0, 0));
        this.addChild(a, 5);
        this.scoreLabel = new cc.LabelAtlas("0", game.NUMBER, 24, 28, "0");
        this.scoreLabel.setPosition(450, 765);
        this.addChild(this.scoreLabel, 2);
        this.scoreLabel.setScale(1.2);
        this.scoreLabel.setAnchorPoint(0.5, 0.5);
        return ! 0
    },
    onEnter: function() {
        this._super();
        this.addSpriteToLayer()
    },
    startUpdate: function() {
        this.schedule(this.loadMoveUpdate, 0.01);
        this.spriteHero.runAction(this.run_action)
    },
    setScoreNumber: function() {
        this.scoreNumber++;
        this.scoreLabel.setString(String(this.scoreNumber))
    },
    jumpCallfunc: function() {
        if (!this.isHeroJump) {
            this.isHeroJump = !0;
            var a = new cc.JumpTo(1.2, cc.p(150, 0), 300, 1);
            this.spriteHero.runAction(a);
            a.setTag(2);
            this.changeSpriteAction()
        }
    },
    addSpriteToLayer: function() {
        this.spriteHero = new cc.Sprite;
        this.spriteHero.setPosition(150, 175);
        this.addChild(this.spriteHero, 2);
        for (var a = new cc.Animation,
        b = 1; 4 >= b; b++) a.addSpriteFrameWithFile(game["SPRITEAC" + b]);
        a.setDelayPerUnit(0.05);
        b = cc.animate(a);
        this.run_action = cc.repeatForever(b);
        this.run_action.setTag(0);
        a = new cc.Animation;
        for (b = 1; 9 >= b; b++) a.addSpriteFrameWithFile(game["SPRITEJUMP" + b]);
        a.setDelayPerUnit(0.02);
        b = cc.animate(a);
        this.jump_action = cc.repeatForever(b);
        this.jump_action.setTag(1)
    },
    changeSpriteAction: function() {
        this.isHeroJump ? (this.spriteHero.stopActionByTag(0), this.spriteHero.runAction(this.jump_action)) : (this.spriteHero.stopActionByTag(1), this.spriteHero.runAction(this.run_action))
    },
    addLoadToLayer: function() {
        var a = new cc.Sprite(game.MOVEBG);
        a.setAnchorPoint(0, 0);
        a.setPosition(520, 0);
        this.addChild(a);
        var b = Math.floor(cc.rand() % 255),
        c = Math.floor(cc.rand() % 255),
        d = Math.floor(cc.rand() % 255);
        a.setColor(cc.color(b, c, d));
        b = Math.random() + 1;
        c = 2.5 - b;
        a.setScaleX(b);
        a.setScaleY(c);
    ...
    loadMoveUpdate: function() {
        var a = 0,
        b;
        for (b in this.mapArray) cc.rectContainsPoint(this.mapArray[b].getBoundingBox(), cc.p(150, this.spriteHero.y - 40)) && a++; ! this.isHeroJump && 0 == a && (this.spriteHero.y -= 20);
        0 >= this.spriteHero.y && (this.spriteHero.y -= 100, this.addOverLayerToScene());
        for (b in this.mapArray) - 50 > this.mapArray[b].x + this.mapArray[b].truewidth ? (this.mapArray[b].removeFromParent(), this.mapArray.splice(b--, 1)) : (this.mapArray[b].x -= 3, cc.rectContainsPoint(this.mapArray[b].getBoundingBox(), this.spriteHero.getPosition()) && (this.spriteHero.x < this.mapArray[b].x + 3 ? this.addOverLayerToScene() : (this.setScoreNumber(), this.isHeroJump = !1, this.spriteHero.stopActionByTag(2), this.spriteHero.y += 30, this.changeSpriteAction())));
        400 > this.mapArray[this.mapArray.length - 1].x + this.mapArray[this.mapArray.length - 1].truewidth && this.addLoadToLayer()
    },
    addOverLayerToScene: function() {
        this.unscheduleAllCallbacks();
        this.isHeroJump = !0;
        currentscore = this.scoreNumber;
        currentscore > bestscore && (bestscore = currentscore);
        var a = new cc.MoveBy(0.5, cc.p( - 200, -300)),
        b = new cc.CallFunc(function() {
            var a = new OverLayer;
            this.addChild(a, 10);
            a.setPosition(0, 500);
            var b = new cc.MoveTo(0.8, cc.p(0, 0)),
            b = new cc.EaseBounceOut(b);
            a.runAction(b)
        },
        this);
        this.spriteHero.runAction(cc.sequence(a, b))
    }
});
var OverLayer = cc.LayerColor.extend({
    ctor: function() {
        ...
        a = new cc.Sprite(game.OVERBG);
        a.setPosition(240, 500);
        this.addChild(a);
        a = new cc.MenuItemImage(game.REPLAYBUT, game.REPLAYBUT, this.replayGame, this);
        a.setPosition(340, 250);
        var b = new cc.MenuItemImage(game.MENUBUT, game.MENUBUT, this.menuGame, this);
        b.setPosition(140, 250);
        a = new cc.Menu(a, b);
        a.setPosition(0, 0);
        this.addChild(a, 1);
        a = new cc.LabelTTF(String(currentscore), "Arial", 40);
        a.setPosition(240, 490);
        this.addChild(a);
        a = new cc.LabelTTF(String(currentscore), "Arial", 40);
        a.setPosition(240, 395);
        this.addChild(a);
		dp_submitScore(currentscore);
		document.getElementById("toolbar").style.display="block";
        return ! 0
    },
    replayGame: function() {//重新开始
        cc.director.runScene(new GameScene);
		document.getElementById("toolbar").style.display="none";
    },
    menuGame: function() {//分享
        dp_share();
    }
});
var GuideLayer = cc.LayerColor.extend({
    gameLayer: null,
    ctor: function(a) {
        this._super(cc.color(0, 0, 20, 50));
        this.gameLayer = a;
        a = new cc.Sprite(game.NEWBG);
        a.setPosition(240, 420);
        this.addChild(a);
        ...
        a = new cc.MenuItemImage(game.CLOSEBUT, game.CLOSEBUT, this.closeGame, this);
        a.setPosition(405, 548);
        a.setScale(1.2);
        a = new cc.Menu(a);
        a.setPosition(0, 0);
        this.addChild(a, 1);
    ...
    closeGame: function() {
        this.gameLayer.startUpdate();
        this.removeFromParent()
    }
});
cc.game.onStart = function() { ! cc.sys.isNative && document.getElementById("cocosLoading") && document.body.removeChild(document.getElementById("cocosLoading"));

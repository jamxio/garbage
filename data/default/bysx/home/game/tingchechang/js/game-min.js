...
(function(b) {
	function c(a) {
		...
		if (k = b.egret_string_code[a]) for (var q = e.length, d = 0; d < q; d++) k = k.replace("{" + d + "}", e[d]);
		return k
	}
	var d = function() {
			function a() {}
			...
			a.traceToConsole = function(e, a, q) {
...
(function(b) {
	var c = function(d) {
			...
			a.prototype.dispatchEventWith = function(e, a, q) {
				void 0 === a && (a = !1);
				b.Event.dispatchEvent(this, e, a, q)
			};
			return a
		}(b.HashObject);
	b.EventDispatcher = c;
...
(function(b) {
	...
	b.getDefinitionByName = function(b) {
		...
		var a = c[b];
		if (a) return a;
		for (var e = b.split("."), k = e.length, a = __global, q = 0; q < k; q++) if (a = a[e[q]], !a) return null;
		return c[b] = a
	}
})(egret || (egret = {}));
...
(function(b) {
	var c = function(d) {
			...
			a.prototype.prependTransform = function(e, a, d, c, g, f, l, m, n) {
				...
				f || l ? (this.prepend(p * d, g * d, -g * c, p * c, 0, 0), this.prepend(b.NumberUtils.cos(l), b.NumberUtils.sin(l), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), e, a)) : this.prepend(p * d, g * d, -g * c, p * c, e, a);
				return this
			};
	...
	var k = function(e) {
			...
			a.prototype._apply = function(e, a, k) {
				...
				var b = this._getClientHeight(),
					...
					q = a / d,
					c = 1;
				0 != this.minWidth && (c = Math.min(1, q / this.minWidth));
...
(function(b) {
	var c = function(d) {
			...
			a.prototype._doAddChild = function(e, k, d) {
				...
				if (this._stage) for (e._onAddToStage(), k = a.__EVENT__ADD_TO_STAGE_LIST; 0 < k.length;) c = k.shift(), d && c.dispatchEventWith(b.Event.ADDED_TO_STAGE);
				e._setDirty();
				this._setSizeDirty();
				return e
			};
			...
			a.prototype._updateTransform = function() {
				if (this._visible) {
					...
					if (!this._cacheAsBitmap || !this._texture_to_render) for (var a = 0, c = this._children, h = c.length; a < h; a++) c[a]._updateTransform();
			...
			a.prototype._render = function(e) {
				if (!b.MainContext.__use_new_draw) for (var a = 0, d = this._children, c = d.length; a < c; a++) d[a]._draw(e)
			};
			a.prototype._measureBounds = function() {
	...
	var c = function(d) {
			...
			a.prototype.getAnimationDatas = function(e, a, b) {
				var d = Math.abs(e),
					c = 0,
					f = a + 500 * e;
				if (0 > f || f > b) for (f = a; Infinity != Math.abs(e) && 0.02 < Math.abs(e);) f += e, e = 0 > f || f > b ? 0.998 * e * 0.95 : 0.998 * e, c++;
				...
				if (g) {
					...
					if ("scale" == c.fillMode) {
						...
						if (m && f - m.width < b && l - m.height < d) a.drawScale9GridImage(e, c, m, b, d);
							...
							n = Math.round(n * d);
							d = Math.round(r * d);
							a.renderFilter.drawImage(e, c, g._bitmapX, g._bitmapY, p, r, m, n, b, d)
						}
	...
	var c = function(d) {
			...
			a.prototype._render = function(e) {
				var k = this._getTextLines(),
					d = k.length;
				if (0 != d) {
					for (var c = this._font, g = c._getFirstCharHeight(), g = Math.ceil(g * a.EMPTY_FACTOR), f = 0, l = this._hasHeightSet ? this._explicitHeight : Number.POSITIVE_INFINITY, m = this._lineHeights, n = 0; n < d; n++) {
						var p = m[n];
						if (0 < n && f + p > l) break;
			...
			a.prototype._getTextLines = function() {
				...
				for (var c = 0, h = 0, g = 0, f = 0, l = this._hasWidthSet, m = this._hasWidthSet ? this._explicitWidth : Number.POSITIVE_INFINITY, n = this._font, p = n._getFirstCharHeight(), r = Math.ceil(p * a.EMPTY_FACTOR), t = this._text.split(/(?:\r\n|\r|\n)/), s = t.length, u = !0, w = 0; w < s; w++) {
					for (var v = t[w], y = v.length, x = 0, z = 0, A = !0, C = 0; C < y; C++) {
						...
						u && (f = Math.min(G, f));
						l && 0 < C && z + B > m ? (e.push(v.substring(0, C)), d.push(x), h += x, c = Math.max(z, c), v = v.substring(C), y = v.length, C = 0, z = B, x = E) : (z += B, x = Math.max(E, x))
					}
					u && (u = !1);
					e.push(v);
					d.push(x);
...
(function(b) {
	var c = function(d) {
			function a() {
				...
				this._strokeColorString = "#FFFFFF";
				...
				for (var m = 0, n = e.length; m < n; m++) {
					...
					for (var r = p.text.toString().split(/(?:\r\n|\r|\n)/), t = 0, s = r.length; t < s; t++) {
						...
						if ("" != r[t]) {
							...
							if (this._hasWidthSet) if (c + u <= this._explicitWidth) l.elements.push({
								width: u,
								text: r[t],
								style: p.style
							}), c += u;
			...
			a.prototype.drawText = function(e) {
				...
				if (0 != this._textMaxWidth) {
					...
					for (var l = 0, m = this._numLines; f < m; f++) {
						var n = a[f],
							p = n.height,
							g = g + p / 2;
			...
			a.prototype._getHit = function(e, a) {
				...
				for (var d = 0, c = 0, f = 0; f < b.length; f++) {
					...
					if (c + this._lineSpacing > a) return null;
					c += this._lineSpacing
				}
				if (0 === d) return null;
				b = b[d - 1];
				for (f = c = 0; f < b.elements.length; f++) if (l = b.elements[f], c + l.width < e) c += l.width;
				else return {
					lineIndex: d - 1,
					textElementIndex: f
				};
	...
	var c = function(b) {
			...
			a.prototype.parseConfig = function(e) {
				...
				for (var a = this.getConfigByKey(e[3], "count"), b = {}, d = 4; d < 4 + a; d++) {
					...
					l.h = this.getConfigByKey(c, "height");
...
(function(b) {
	var c = function(d) {
			...
			a.prototype._getFrameLabelByName = function(e, a) {
				...
				if (b) for (var d = null, c = 0; c < b.length; c++) if (d = b[c], a ? d.name.toLowerCase() === e : d.name === e) return d;
				return null
			};
			a.prototype._getFrameLabelByFrame = function(e) {
				var a = this._frameLabels;
				if (a) for (var b = null, d = 0; d < a.length; d++) if (b = a[d], b.frame === e) return b;
				return null
			};
...
(function(b) {
	var c = function(d) {
			...
			a.prototype.$ = function(e) {
				var d = document;
				if (e = e instanceof HTMLElement ? e : d.querySelector(e)) e.find = e.find || this.$, e.hasClass = e.hasClass ||
				function(a) {
...
(function(b) {
	var c = function() {
			...
			d.parseNode = function(a) {
				...
				b = a.childNodes;
				c = b.length;
				for (h = 0; h < c; h++) if (g = d.parseNode(b[h])) e.children || (e.children = []), g.parent = e, e.children.push(g);
...
(function(b) {
	...
	var d = function() {
			...
			a.prototype.readBytes = function(e, b, d) {
				...
				for (var c = 0; c < d; c++) e.data.setUint8(c + b, this.data.getUint8(this.position++))
			};
				...
				for (var b = 0, d = "", c, g = 0, f = 0, l = 0, m = 0; a.length > b;) {
					...
					if (c === this.EOF_byte) c = 0 !== f ? this.decoderError(!1) : this.EOF_code_point;
						...
						var n = g,
							p = m,
							m = l = f = g = 0;
						c = this.inRange(n, p, 1114111) && !this.inRange(n, 55296, 57343) ? n : this.decoderError(!1, c)
...
(function(b) {
	var c = function(d) {
			...
			a.removeTweens = function(e) {
				if (e.tween_count) {
					for (var b = a._tweens, d = b.length - 1; 0 <= d; d--) b[d]._target == e && (b[d].paused = !0, b.splice(d, 1));
					e.tween_count = 0
				}
			};
			...
			a.prototype._updateTargetProps = function(e, b) {
				...
				for (var l in this._initQueueProps) {
					...
					var m = !1;
					if (f = a._plugins[l]) for (var n = 0, p = f.length; n < p; n++) {
			...
			a.prototype._appendQueueProps = function(e) {
				...
				for (l in e) if (void 0 === this._initQueueProps[l]) {
					d = this._target[l];
					if (b = a._plugins[l]) for (c = 0, g = b.length; c < g; c++) d = b[c].init(this, l, d);
					this._initQueueProps[l] = this._curQueueProps[l] = void 0 === d ? null : d
				}
				for (l in e) {
					d = this._curQueueProps[l];
					if (b = a._plugins[l]) for (f = f || {}, c = 0, g = b.length; c < g; c++) b[c].step && b[c].step(this, l, d, e[l], f);
...
(function(b) {
	var c = function(d) {
			...
			a.prototype.drawImage = function(a, c, q, h, g, f, l, m, n, p) {
				...
				l += this._transformTy;
				var t = b.getTimer();
				void 0 === p ? this.drawCanvasContext.drawImage(r, c, q, h, g, f, l, m, n) : this.drawRepeatImage(a, c, q, h, g, f, l, m, n, p);
			...
			a.prototype.drawText = function(a, c, q, h, g, f) {
				...
				p.fillStyle = l;
				p.strokeStyle = m;
				n && (p.lineWidth = 2 * n, p.strokeText(c, q + this._transformTx, h + this._transformTy, g || 65535));
			...
			a.prototype.onRenderFinish = function() {
				this.drawCanvasContext.restore();
				this.drawCanvasContext.setTransform(1, 0, 0, 1, 0, 0);
				if (this.useCacheCanvas) for (var a = this._cacheCanvas.width, d = this._cacheCanvas.height, c = b.RenderFilter.getInstance().getDrawAreaList(), h = 0, g = c.length; h < g; h++) {
					var f = c[h],
						l = f.x,
						m = f.y,
						n = f.width,
...
(function(b) {
	...
	b.drawCircle = function(b, a, e) {
		this._pushCommand(new c(function(a, e, b) {
	...
	b.drawRoundRect = function(b, a, e, k, q, h) {
		this._pushCommand(new c(function(a, e, b, d, c, k) {
			...
			this.canvasContext.quadraticCurveTo(b, d, b - c, d);
	...
	var c = function(d) {
			...
			a.prototype.initAll = function() {
				a.isInit || (a.isInit = !0, egret_webgl_graphics.init(), b.TextField.prototype._makeBitmapCache = function() {
					...
					m = a._anchorOffsetX;
					n = a._anchorOffsetY;
					if (0 != a._anchorX || 0 != a._anchorY) m = a._anchorX * d, n = a._anchorY * h;
					this._offsetX = g + m;
					this._offsetY = f + n;
					...
					b.MainContext.__use_new_draw = !1;
					if (a instanceof b.DisplayObjectContainer) for (f = a._children, m = 0, n = f.length; m < n; m++) f[m]._updateTransform();
			...
			a.prototype.drawRepeatImage = function(a, d, c, h, g, f, l, m, n, p) {
				...
				h *= p;
				for (g *= p; f < m; f += h) for (var r = l; r < n; r += g) {
			...
			a.prototype.drawImage = function(a, b, d, c, g, f, l, m, n, p) {
				void 0 === p && (p = void 0);
				if (!this.contextLost) if (void 0 !== p) this.drawRepeatImage(a, b, d, c, g, f, l, m, n, p);
				else {
					this.createWebGLTexture(a);
					p = a._bitmapData.webGLTexture[this.glID];
					if (p !== this.currentBaseTexture || this.currentBatchSize >= this.size - 1) this._draw(), this.currentBaseTexture = p;
			...
			a.prototype.getScissorRect = function(a) {
				...
				(d = this.maskDataFreeList.pop()) ? (d.x = c, d.y = h, d.width = g, d.height = a) : d = new b.Rectangle(c, h, g, a);
				return d
			};
			a.prototype.popMask = function() {
				this._draw();
...
(function(b) {
	var c = function(d) {
			...
			a.getHeader = function() {
				for (var a = document.createElement("div").style, b = ["t", "webkitT", "msT", "MozT", "OT"], d = 0; d < b.length; d++) if (b[d] + "ransform" in a) return b[d];
				return b[0]
			};
			...
			a.prototype.setStyles = function() {
				...
				this.setElementStyle("color", "#ffffff");
			...
			d.prototype.parseConfig = function(a, b) {
				if (a) {
					...
					if (d = a.groups) for (c = d.length, h = 0; h < c; h++) {
						for (var f = d[h], l = [], m = f.keys.split(","), n = m.length, p = 0; p < n; p++) g = m[p].trim(), (g = this.keyMap[g]) && -1 == l.indexOf(g) && l.push(g);
	...
	var c = function(d) {
			...
			a.prototype.onItemComplete = function(a) {
				...
				if (!a.loaded) {
					...
					if (c > this.maxRetryTimes) delete this.retryTimesDic[a.name], b.ResourceEvent.dispatchResourceEvent(this.resInstance, b.ResourceEvent.ITEM_LOAD_ERROR, d, a);
					else {
			...
			d.prototype.getResByUrl = function(a, d, e, c) {
				...
				if (a) {
					...
					f ? d.call(e, f) : (d = {
						...
						compFunc: d,
						thisObject: e
					}, this.asyncDic[a] ? this.asyncDic[a].push(d) : (this.asyncDic[a] = [d], a = new b.ResourceItem(a, a, c), this.resLoader.loadItem(a)))
				} else d.call(e, null)
			};
...
function(b, c) {
	...
	c.prototype.onAddToStageHandler = function(b) {
		if (!c.stage) {
			...
			c.isDebug && (console.log("DebugModel"), console.log("gamename: " + c.gamename), console.log("nameid: " + c.nameid), console.log("AppVersion: " + c.version));
	...
	c.prototype.onTouchPlayHandler = function(b) {
		...
		this.__loadingSkin.getImage("playBtn").removeEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchPlayHandler, this);
	...
	c.prototype.__removeTimerHandler = function(b) {
		b.currentTarget.removeEventListener(egret.TimerEvent.TIMER, this.__removeTimerHandler, this);
	...
	c.prototype.logoTween = function(b, a, e) {
		if (this.__loadingSkin) {
			...
			c.stage.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchLogoHandler, this)
		}
	};
	...
	c.prototype.alignMiniLogo = function(b) {
		...
		case 3:
			...
			break;
		case 4:
			a.x = (c.stage.stageWidth - this.__miniLogo.width * this.__miniLogo.scaleX) / 2;
			break;
		case 5:
	...
	c.OpenHomepage = function(b) {
		void 0 === b && (b = "http://www.gzacwl.com/");
		c.OpenUrl(b)
	};
	c.Version = function() {
...
function(b, c) {
	...
	function c() {
		...
		for (var a, e, d = RES.getRes("fntParking"), c = 0; c < Game.MAX_LV; c++) a = this.sp_gezi.getSprite("a" + c), e = a.getImage("btn_click"), e.alpha = 0, e.touchEnabled = !0, e = a.getMovie("list_car"), e.stop(), e.visible = !1, e = a.getImage("select"), e.visible = !1, e = new egret.BitmapText, e.font = d, e.text = c + 1 + "", e.y = -13, e.x = -15, e.scaleX = e.scaleY = 0.7, 10 > c && (e.x = 0), a = a.getSprite("carNum"), a.addChild(e)
	}
	__extends(c, b);
	...
	c.prototype.onMouseDownHandler = function(b) {
		...
		App.stage.addEventListener(egret.TouchEvent.TOUCH_MOVE, this.onMouseMoveHandler, this);
...
(function(b) {
	var c = function() {
			...
			d.prototype.createSprite = function(a, c, k) {
				...
				null != c && b.SwfBlendMode.setBlendMode(a, c[11]);
				return a
			};
...
(function(b) {
	var c = function(d) {
			...
			a.prototype.update = function() {
				if (this._isPlay) if (this._currentFrame > this._endFrame) {
					var a = !1;
					this.loop && this._startFrame != this._endFrame || (this._ownerSwf && this.stop(!1), a = !0);
			...
			a.prototype.setCurrentFrame = function(a) {
				...
				for (var d, c, h = this.__frameInfos.length, g = 0; g < h; g++) {
					...
					case b.Swf.dataKey_TextField:
						...
						break;
					default:
						d._scaleX = a[4], d._scaleY = a[5], b.SwfBlendMode.setBlendMode(d, a[11])
					}
			...
			a.prototype.play = function() {
				...
				var a, d, c;
				for (a in this._displayObjects) if (0 == a.indexOf(b.Swf.dataKey_MovieClip)) {
					d = this._displayObjects[a];
					c = d.length;
					for (var h = 0; h < c; h++) d[h].play()
				}
			};
			a.prototype.stop = function(a) {
				...
				if (a) {
					var d, c, h;
					for (d in this._displayObjects) if (0 == d.indexOf(b.Swf.dataKey_MovieClip)) {
			...
			a.prototype.getLabelData = function(a) {
				for (var b = this._labels.length, d, c = 0; c < b; c++) if (d = this._labels[c], d[0] == a) return d;
				return null
			};
			...
			a.prototype.removeEventListener = function(a, b, c, h) {
				void 0 === h && (h = !1);
				d.prototype.removeEventListener.call(this, a, b, c, h);
				this._hasCompleteListener = this.hasEventListener(egret.Event.COMPLETE)
			};
			return a
		}(b.SwfSprite);
...
function(b, c) {
	...
	c.prototype.init = function() {
		...
		var a = b.getImage("btn_t"),
			c = b.getImage("btn_f");
		c.touchEnabled = a.touchEnabled = !0;
		...
		this.shareTxt.text = "你打败99％的全球玩家\n分享给你的朋友。\n幸福来源于分享！";
	...
	c.prototype.onTwitter = function(b) {
		this.beatPer = Math.min(99, Math.round(100 * Math.sqrt(this.score / 2E5)));
		console.log("twitter" + this.score, this.beatPer);
	...
	c.prototype.setData = function(b, a) {
		...
		this.visible = !0;
		this.beatPer = Math.min(99, Math.round(100 * Math.sqrt(this.score / 2E5)));
		this.shareTxt.text = "你打败 " + this.beatPer + "% 的全球玩家 \n分享给你的朋友。\n幸福来源于分享！";
		this.lvTxt.text = b + "";
...
function(b, c) {
	...
	function c() {
		...
		this.bridges33 = "01,05,12,15,23,24,34,45";
	...
	c.prototype.init = function() {
		...
		for (var b = 0, b = 0; 6 > b; b++) {
			if (0 < b) {
				var a = this.gameScreen.getMovie("car" + b);
				a.stop();
	...
	c.prototype.gameInit = function() {
		for (var b = 1; 5 >= b;) this.parkingArrMC[b].gotoAndStop(b - 1), this.carArrMC[b - 1].gotoAndStop(b - 1), this.gameScreen.setChildIndex(this.carArrMC[b - 1], 500 + b), ++b;
	...
	c.prototype.prepareBoard = function(b, a) {
		void 0 === a && (a = !0);
		this.gameScorePanel.setData(this.currentBoard, this.score, this.moves, this.maxMoves);
		...
		for (c = 0; c < this.bridgesArray.length;) this.bridgesArray[c].substr(0, 1) > this.bridgesArray[c].substr(1, 1) && (this.bridgesArray[c] = this.bridgesArray[c].substr(1, 1) + this.bridgesArray[c].substr(0, 1)), this.gameScreen.getChildByName("bridge" + this.bridgesArray[c])._visible = !0, this.gameScreen.setChildIndex(this.gameScreen.getChildByName("bridge" + this.bridgesArray[c]), 1E3 + 100 * c), ++c;
		...
		!0 == a && (this.moves = 0, this.gameScorePanel.setData(this.currentBoard, this.score, this.moves, this.maxMoves));
	...
	c.prototype.crossBridge = function(b) {
		...
		this.animation ? (this.buttonsBlocked(!0), b = this.parkingNum > this.freeParking ? this.freeParking.toString() + this.parkingNum : this.parkingNum.toString() + this.freeParking, b = this.gameScreen.getMovie("bridge" + b), this.curCar.parent.setChildIndex(this.curCar, b.parent.getChildIndex(b) + 1), this.rotateCarToFree(this.curCar), this.gas = this.curCar.getMovie("gas"), this.gas.play(), this.gas.addEventListener(egret.Event.ENTER_FRAME, this.gasPlay, this), this.xStartDistance = this.curParking._x - this.curCar._x, this.yStartDistance = this.curParking._y - this.curCar._y, this.curCar.addEventListener(egret.Event.ENTER_FRAME, this.CaronEnterFrame, this)) : (this.curCar._x = this.curParking._x, this.curCar._y = this.curParking._y, this.carOnParking[this.parkingNum] = 0, this.carOnParking[this.freeParking] = this.carToMove, this.freeParking = this.parkingNum, ++this.moves, this.gameScorePanel.setData(this.currentBoard, this.score, this.moves, this.maxMoves), this.checkPositions(), this.stoppedRotatingCars = 0, this.rotateAllConnectedCars())
	};
	...
	c.prototype.CaronEnterFrame = function() {
		...
		this.curCar._x += this.xStartDistance / 30;
		this.curCar._y += this.yStartDistance / 30;
		5 > Math.abs(this.xxDistance) && 5 > Math.abs(this.yyDistance) && (this.curCar._x = this.curParking._x, this.curCar._y = this.curParking._y, this.carOnParking[this.parkingNum] = 0, this.carOnParking[this.freeParking] = this.carToMove, this.freeParking = this.parkingNum, ++this.moves, this.gameScorePanel.setData(this.currentBoard, this.score, this.moves, this.maxMoves), this.checkPositions(), this.stoppedRotatingCars = 0, this.rotateAllConnectedCars(), this.curCar.removeEventListener(egret.Event.ENTER_FRAME, this.CaronEnterFrame, this))
	};
	...
	c.prototype.carStoppedRotating = function() {
	...
	c.prototype.addScore = function(b) {
		...
		(b ? parseInt(b) : 1) <= this.currentBoard && xht.saveStorageData(Game.HIGHT_LV, this.currentBoard + "")
	};
	...
	c.prototype.rotateCarToFree = function(b) {
		function a() {
			var c = k - b._rotation;
			if (10 < Math.abs(c)) if (0 < c && 180 > c || -360 < c && -180 > c) {
...
(function(b) {
	var c = function() {
			...
			b.prototype.createBitmap = function(a) {
				var b, c;
				for (c in this._sheets) if (b = this._sheets[c], b = b.getTexture(a), null != b) break;
...
(function(b) {
	var c = function() {
			...
			b.prototype.updateAdd = function() {
				for (var a = this._addQueue.length, b, c, d = 0; d < a; d++) c = this._addQueue.pop(), b = this._animations.indexOf(c), -1 == b && this._animations.push(c)
			};

...
(function(t) {
	...
	function l(t, n, r, o, a) {
		this.version = "0.10.3", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new t({
			isMaster: !0
	...
	f.argsToArray = function(t) {
		...
		return /yx8.com/.test(window.location.host)
	}, f.getRole = function() {
		...
		window.XDomainRequest ? (n = new XDomainRequest, n.onload = function() {
			...
			4 === n.readyState && e(n.status, n.responseText)
		}), a && (i = ["configs.xml", o, r, a].join("/"), n.open("GET", i, !0), n.timeout = 3e3, n.ontimeout = function() {
			e(404, null)
		}, n.send())
	...
	d.getGameConfig = function() {
				...
				configar: {
					branding: {
						main: {
							...
							url: "http://www.gzacwl.com/productcenter.html",
							style: "",
							width: "202",
							height: "50",
							mime: "image/png",
		...
		var n, i, r = null;
		return this.get(t) ? (n = "update", r = this.get(t)) : n = "new", this.put(t, e), i = Date.parse(new Date), this.notify({
			type: n,
			key: t,
			current: e,
			previous: r,
		...
		function n(e) {
			return a.IS_MASTER && (e = i(e)), a.isReady = !0, a.Branding.moduleReady = !0, a.__.EventTracking.moduleReady = !0, a.GameBreak.moduleReady = !0, a.Game.moduleReady = !0, a.Branding.init({
				data: e

...
window.onload = function() {
    ...
    com.get("superPlay").addEventListener("click",
    function(e) {
        //if (confirm("确认开始大师级对弈？")) {
        if (layer.confirm("确认开始大师级对弈？")) {
            play.isPlay = true;
            gameDifficulty = "大师";
            play.depth = 4;
            play.init()
    ...
    com.get("normalPlay").addEventListener("click",
    function(e) {
        //if (confirm("确认开始中级对弈？")) {
        if (layer.confirm("确认开始中级对弈？")) {
            play.isPlay = true;
            gameDifficulty = "中级";
            play.depth = 3;
            play.init()
    ...
    com.get("tyroPlay").addEventListener("click",
    function(e) {
        //if (confirm("确认开始新手级对弈？")) {
        if (layer.confirm("确认开始新手级对弈？")) {
            play.isPlay = true;
            gameDifficulty = "新手";
            play.depth = 2;
            play.init()
...
com.loadImages = function(e) {
    ...
    for (var t in com.args) {
        com[t] = {};
        com[t].img = new Image;
        com[t].img.src = "img/" + com.args[t].img + ".png"
    }
    com.paneImg = new Image;
    com.paneImg.src = "img/r_box.png";
...
play.init = function() {
    ...
    com.get("regretBn").addEventListener("click",
    function(e) {
        play.regret()
    })
};
...
play.clickMan = function(e, t, n) {
    ...
    if (play.nowManKey && play.nowManKey != e && r.my != com.mans[play.nowManKey].my) {
        ...
        if (r.my === 1) {
            ...
            r.alpha = 1;
            com.showPane(com.mans.x, com.mans.y, t, n);
            com.pane.isShow = true;
            play.nowManKey = e;

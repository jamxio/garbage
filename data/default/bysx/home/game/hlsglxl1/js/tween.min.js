...
function(t) {
	var n = function(n) {
			...
			return e.get = function(t, n, i, s) {
			...
			}, s._updateTargetProps = function(t, n) {
				var i, s, u, r, o, a;
				if (t || 1 != n) {
				...
				for (var o in t) if (void 0 === this._initQueueProps[o]) {
					if (i = this._target[o], n = e._plugins[o]) for (s = 0, u = n.length; u > s; s++) i = n[s].init(this, o, i);
					this._initQueueProps[o] = this._curQueueProps[o] = void 0 === i ? null : i
				} else i = this._curQueueProps[o];
				for (var o in t) {
					if (i = this._curQueueProps[o], n = e._plugins[o]) for (r = r || {}, s = 0, u = n.length; u > s; s++) n[s].step && n[s].step(this, o, i, t[o], r);

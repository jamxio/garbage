	...
	function(t) {
		var i = function(i) {
				...
				return o.load = function(t) {
					function i() {
						o(), l.indexOf("firefox") >= 0 && (a.pause(), a.muted = !1), s.loaded = !0, s.dispatchEventWith(e.Event.COMPLETE)
					}
					function r() {
					...
					this.url = t;
					var a = new Audio(t);
					a.addEventListener("canplaythrough", i), a.addEventListener("error", r);
					var l = navigator.userAgent.toLowerCase();
					l.indexOf("firefox") >= 0 && (a.autoplay = !0, a.muted = !0), a.load(), this.originAudio = a, n.$recycle(this.url, a)
				}, o.play = function(i, r) {
					i = +i || 0, r = +r || 0;
					var o = n.$pop(this.url);
					null == o && (o = this.originAudio.cloneNode()), o.autoplay = !0;
					var s = new t.HtmlSoundChannel(o);
					return s.$url = this.url, s.$loops = r, s.$startTime = i, s.$play(), e.sys.$pushSoundChannel(s), s
				}, o.close = function() {
	...
	function(t) {
		var i = function(i) {
				...
				return o.load = function(i) {
					...
					i = +i || 0, n = +n || 0;
					var r = new t.QQSoundChannel;
					return r.$url = this.url, r.$loops = n, r.$type = this.type, r.$startTime = i, r.$play(), e.sys.$pushSoundChannel(r), r
	...
	function(t) {
		...
		var n = function(n) {
				...
				return s.load = function(t) {
					...
					i = +i || 0, n = +n || 0;
					var r = new t.WebAudioSoundChannel;
					return r.$url = this.url, r.$loops = n, r.$audioBuffer = this.audioBuffer, r.$startTime = i, r.$play(), e.sys.$pushSoundChannel(r), r
...
function(e) {
	...
	function(t) {
		var i = function(t) {
				...
				}, o.setFullScreenMonitor = function(e) {
					var t = this.video;
	...
	function(t) {
		var i = function(t) {
				...
				var n = __define,
					r = i,
					o = r.prototype;
				return n(o, "response", function() {
					return this._xhr ? void 0 != this._xhr.response ? this._xhr.response : this._xhr.responseXML ? this._xhr.responseXML : void 0 != this._xhr.responseText ? this._xhr.responseText : null : null
				}), n(o, "responseType", function() {
					return this._responseType
				}, function(e) {
					this._responseType = e
				}), n(o, "withCredentials", function() {
		...
		var i = window.URL || window.webkitURL,
			n = function(n) {
				...
				var o = __define,
					s = r,
					a = s.prototype;
				return o(a, "crossOrigin", function() {
				...
				}, a.onBlobLoaded = function(e) {
					var t = this.request.response;
					this.loadImage(i.createObjectURL(t))
				}, a.onBlobError = function(e) {
					this.dispatchIOError(this.currentURL)
				}, a.loadImage = function(e) {
					var t = new Image;
					this.data = null, this.currentImage = t, this._hasCrossOriginSet ? this._crossOrigin && (t.crossOrigin = this._crossOrigin) : r.crossOrigin && (t.crossOrigin = r.crossOrigin), t.onload = this.onImageComplete.bind(this), t.onerror = this.onLoadError.bind(this), t.src = e
				}, a.onImageComplete = function(t) {
...
function(e) {
	...
	function(t) {
		var i = function(i) {
				...
				var r = (__define, n),
					o = r.prototype;
				return o.$setTextField = function(e) {
					return this.$textfield = e, !0
				}, o.$addToStage = function() {
					this.htmlInput = e.web.$getTextAdapter(this.$textfield)
				}, o._initElement = function() {
					...
					this.inputDiv.style.left = t * o + "px", this.inputDiv.style.top = i * s + "px", this.$textfield.multiline ? (this.inputDiv.style.top = i * s + "px", this.inputElement.style.top = -this.$textfield.lineSpacing / 2 * s + "px") : (this.inputDiv.style.top = i * s + "px", this.inputElement.style.top = "0px"), this._gscaleX = o * n, this._gscaleY = s * r
				}, o.$show = function() {
					...
					if (t.Html5Capatibility._System_OS == t.SystemOSType.WPHONE) {
						...
						null == n[35] && null == n[36] ? (i.textValue = i.inputElement.value, e.Event.dispatchEvent(i, "updateText", !1)) : window.setTimeout(function() {
							i.inputElement.selectionStart == i.inputElement.selectionEnd && (i.textValue = i.inputElement.value, e.Event.dispatchEvent(i, "updateText", !1))
						}, 0)
					} else window.setTimeout(function() {
						i.inputElement.selectionStart == i.inputElement.selectionEnd && (i.textValue = i.inputElement.value, e.Event.dispatchEvent(i, "updateText", !1))
					}, 0)
				}, o.setAreaHeight = function() {
...
function(e) {
	...
	function(t) {
		var i = function() {
				...
				}, n.isCurrentStageText = function(e) {
					return this._stageText == e
				}, n.initValue = function(e) {
				...
				}, n._initStageDelegateDiv = function(t, i) {
					this.canvas = i;
					var n, r = this;
				...
				}, n.disconnectStageText = function(e) {
...
function(e) {
	...
	function(t) {
		var i = [],
			...
			r = function() {
				function t() {
					e.sys.sharedRenderContext = this.create().renderContext, e.sys.hitTestRenderContext = this.create().renderContext;
				...
				}, o.testCanvasValid = function(e) {
					e.height = 1, e.width = 1;
					var t = e.toDataURL("image/png");
					return "data:," == t ? !1 : !0
				}, o.createSurface = function(t) {
					var i = t.getContext("2d");
					if (t.renderContext = i, i.surface = t, e.$toBitmapData(t), void 0 === i.imageSmoothingEnabled) {
...
function(e) {
	...
	function(t) {
		var i = function(t) {
				...
				var n = (__define, i),
					r = n.prototype;
				return r.addListeners = function() {
					var t = this;
				...
				}, r.updateScaleMode = function(e, t, i) {
					this.scaleX = e, this.scaleY = t, this.rotation = i
				}, r.$updateMaxTouches = function() {
...
function(e) {
	...
	function(t) {
		var i = function(t) {
				...
				var n = (__define, i),
					r = n.prototype;
				return r.registerListener = function() {
					var t = this,
						i = function() {
		...
		var i = function(i) {
				...
				return o.init = function(i) {
					...
					if (!t.userTyping) {
						...
						var v = d / h,
							f = c / u;
						this.webTouchHandler.updateScaleMode(v, f, p), this.webInput.$updateSize(), this.player.updateStageSize(h, u)
					}
				}, o.setContentSize = function(e, t) {
					var i = this.playerOption;
					i.contentWidth = e, i.contentHeight = t, this.updateScreenSize()
				}, o.updateMaxTouches = function() {

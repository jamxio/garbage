...
function() {
	function a() {
		"undefined" != typeof seajs_gzacwl_h5api && "undefined" != typeof e4f9a75bcfa78ae97f1461a38bb5e01a ? (seajs_gzacwl_h5api.config({
			base: c,
			alias: {
				//Main: "Main.js?v=" + e4f9a75bcfa78ae97f1461a38bb5e01a
			}
		}), seajs_gzacwl_h5api.use("Main")) : setTimeout(a, 1)
	}
	function b(a) {
	...
	c = c[c.length - 1].src.substring(0, c[c.length - 1].src.lastIndexOf("/") + 1), b(c + "sea_gzacwl_h5api.js"), b(c + "h5api_version.js?random=" + Math.random()), a()
}();
var ApiEvent = {
	User: {
		LOGIN: "userLogin",
